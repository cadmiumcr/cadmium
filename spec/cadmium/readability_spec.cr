...
describe Cadmium::Readability do
  ...
  long_text = "Human reason, in one sphere of its cognition, is called upon to consider questions, which it cannot decline, as they are presented by its own nature, but which it cannot answer, as they transcend every faculty of the mind.
  ...
  results =
    {
      "long" => {
        ...
        "Average words per sentence"  => 35.13513513513514,
        "Average syllables per word"  => 1.603846153846154,
        "Flesch score"                => 35.49,
        "Flesch-Kincaid grade level"  => 17.04,
        "Fog Index"                   => 20.88,
        "SMOG grade level"            => 17.122413403193683,
        "Automated Readability Index" => 19.62,
        "Coleman-Liau Index"          => 18.36,
        "LIX Index"                   => 59.00,
        "Linsear Write Index"         => 23.57,
      },
      "short" => {
        ...
        "Average words per sentence"  => 22.90909090909091,
        "Average syllables per word"  => 1.507936507936508,
        "Flesch score"                => 56.01,
